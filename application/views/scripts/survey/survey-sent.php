  ...
  <div class="content">
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        <h2 class="content-header-title">Sent Surveys</h2>
        <ol class="breadcrumb">
          <li><a href="./index.html">Home</a></li>
          <li class="active">Surveys Sent</li>
        </ol>
      </div> <!-- /.content-header -->
              ...
              >
                  ...
                  <tbody>
                    <tr>
                      ...
                      <a href="#" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#deleteSurveys"><i class="fa fa-times"></i></a>
                      </td>
                    </tr>
                    <tr >
                      <td class="checkbox-column">
               ...
               <a href="#" class="btn btn-success" >Delete Surveys</a>
    ...
    <div class="modal fade" id="deleteSurveys" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
			...
			<div class="modal-content">
			    ...
			    <div class="modal-body">
			 	...
			 	<div class="modal-footer">
			        ...
			        <a href="/survey-sent.php" class="btn btn-warning">DELETE</a>
			     </div>
			 </div>
		</div>
	</div><!-- /.modal -->
